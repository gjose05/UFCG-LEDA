...
public class HashtableClosedAddressImpl<T> extends
	...
	public void insert(T element) {
		if (element != null){
			int posicao =  ((HashFunctionClosedAddress) this.hashFunction).hash(element);
	...
	public void remove(T element) {
		if (element != null){
			int posicao =  ((HashFunctionClosedAddress) this.hashFunction).hash(element);
			if (this.table[posicao] != null){
				((LinkedList<T>) this.table[posicao]).remove(element);
				this.elements--;
				if (this.table[posicao] == null){
					this.COLLISIONS--;
				}
	...
	public T search(T element) {
		...
		if (element != null){
			int posicao =  ((HashFunctionClosedAddress) this.hashFunction).hash(element);
			if (this.table[posicao] != null){
				if (((LinkedList<T>) this.table[posicao]).contains(element) == true){
					resp = element;
				}
			}
		}
